            ...
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mt-1">Chi tiết công việc</p>
                    </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 dark:text-gray-100">{{ $task->deadline->format('d/m/Y') }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-gray-400 mr-3 flex-shrink-0" fill="none" stroke="currentColor"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 dark:text-gray-100">{{ $task->created_at->format('d/m/y') }} lúc {{ $task->created_at->format('H:i') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 dark:text-gray-100">{{ $task->user->phone_number }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 dark:text-gray-100">{{ $task->client->customer_name }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-gray-400 mr-3 flex-shrink-0" fill="none" stroke="currentColor"
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Email</p>
                                        <p class="text-gray-900 dark:text-gray-100">{{ $task->client->customer_email }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-gray-400 mr-3 flex-shrink-0" fill="none" stroke="currentColor"
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Số điện thoại</p>
                                        <p class="text-gray-900 dark:text-gray-100">{{ $task->client->customer_phone }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Tên dự án</p>
                                        <p class="text-gray-900 dark:text-gray-100">{{ $task->project->title }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Trạng thái dự án</p>
                                        <span
